...
public class WorkoutSessionExerciseSetService {
    ...
    public WorkoutSessionExerciseSet getWorkoutSessionExerciseSetEntityById(Long workoutSessionExerciseSetId) {
        log.info("[METHOD]: getWorkoutSessionExerciseSetEntityById - Fetching workoutSessionExerciseSet by ID: {}", workoutSessionExerciseSetId);

        return workoutSessionExerciseSetRepository.findById(workoutSessionExerciseSetId).orElseThrow(() -> {
            log.warn("[METHOD]: getWorkoutSessionExerciseSetEntityById - workoutSessionExerciseSet was not found by ID: {}", workoutSessionExerciseSetId);
    ...
    public void deleteWorkoutSessionExerciseSetById(Long workoutSessionExerciseSetId) {
        log.info("[METHOD]: deleteWorkoutSessionExerciseSetById - Deleting workoutSessionExerciseSet by ID: {}", workoutSessionExerciseSetId);

        workoutSessionExerciseSetRepository.deleteById(workoutSessionExerciseSetId);
        log.info("[METHOD]: deleteWorkoutSessionExerciseSetById - workoutSessionExerciseSet by ID: {} was deleted", workoutSessionExerciseSetId);
    }
}
